...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public sample.sb.model.Foo addFoo(sample.sb.model.Foo foo) {
	 ...
	 */
	@Override
	public sample.sb.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public sample.sb.model.Foo deleteFoo(sample.sb.model.Foo foo) {
	 ...
	 */
	@Override
	public sample.sb.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public sample.sb.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public sample.sb.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 */
	@Override
	public sample.sb.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public sample.sb.model.Foo getFooByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<sample.sb.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<sample.sb.model.Foo> getFoosByUuidAndCompanyId(
	...
	public java.util.List<sample.sb.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<sample.sb.model.Foo>
			orderByComparator) {
	 ...
	 */
	@Override
	public sample.sb.model.Foo updateFoo(sample.sb.model.Foo foo) {
